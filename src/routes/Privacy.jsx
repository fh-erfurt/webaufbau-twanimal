...
import style from '../assets/css/routes/imprintPrivacy.module.scss';
			...
			<React.Fragment>
				<div className={style.Privacy}>
					...
					<p>
						...
						hohen Stellenwert für die Geschäftsleitung der Twanimal GmbH. Eine Nutzung der Internetseiten
						der Twanimal GmbH ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern
					...
					<p>
						...
						Datenschutz-Grundverordnung und in Übereinstimmung mit den für die Twanimal GmbH geltenden
					...
					<p>
						Die Twanimal GmbH hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
					...
					<p>
						Die Datenschutzerklärung der Twanimal GmbH beruht auf den Begrifflichkeiten, die durch den
					...
					<p>Twanimal GmbH</p>
					<p>Altonaer Straße 25</p>
					<p>99085 Erfurt</p>
					<p>Deutschland</p>
					<p>Tel.: 0324512426</p>
					<p>E-Mail: twanimal@web.de</p>
					<p>Website: www.twanimal.de</p>

					<h4>3. Cookies</h4>
					<p>
						Die Internetseiten der Twanimal GmbH verwenden Cookies. Cookies sind Textdateien, welche über
					...
					<p>
						Durch den Einsatz von Cookies kann die Twanimal GmbH den Nutzern dieser Internetseite
					...
					<p>
						Die Internetseite der Twanimal GmbH erfasst mit jedem Aufruf der Internetseite durch eine
					...
					<p>
						Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Twanimal GmbH keine
						Rückschlüsse auf die betroffene Person. Diese Informationen werden vielmehr benötigt, um (1) die
						Inhalte unserer Internetseite korrekt auszuliefern, (2) die Inhalte unserer Internetseite sowie
						...
						notwendigen Informationen bereitzustellen. Diese anonym erhobenen Daten und Informationen werden
						durch die Twanimal GmbH daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den
					...
					<p>
						Die Internetseite der Twanimal GmbH enthält aufgrund von gesetzlichen Vorschriften Angaben, die
					...
					<ul style={{ listStyle: 'none' }}>
						...
						<li>
							...
							<p>
								...
								von personenbezogenen Daten, die bei der Twanimal GmbH gespeichert sind, veranlassen
								möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
								Verantwortlichen wenden. Der Mitarbeiter der Twanimal GmbH wird veranlassen, dass dem
								Löschverlangen unverzüglich nachgekommen wird.
							</p>

							<p>
								Wurden die personenbezogenen Daten von der Twanimal GmbH öffentlich gemacht und ist
								unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
								personenbezogenen Daten verpflichtet, so trifft die Twanimal GmbH unter Berücksichtigung
								...
								erforderlich ist. Der Mitarbeiter der Twanimal GmbH wird im Einzelfall das Notwendige
								veranlassen.
							</p>
						</li>
						<li>
							...
							<p>
								...
								die Einschränkung von personenbezogenen Daten, die bei der Twanimal GmbH gespeichert
								sind, verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
								Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Twanimal GmbH wird die
						...
						<li>
							...
							<p>
								...
								jederzeit an einen Mitarbeiter der Twanimal GmbH wenden.
							</p>
						</li>
						<li>
							...
							<p>
								Die Twanimal GmbH verarbeitet die personenbezogenen Daten im Falle des Widerspruchs
							...
							<p>
								Verarbeitet die Twanimal GmbH personenbezogene Daten, um Direktwerbung zu betreiben, so
								...
								betroffene Person gegenüber der Twanimal GmbH der Verarbeitung für Zwecke der
								Direktwerbung, so wird die Twanimal GmbH die personenbezogenen Daten nicht mehr für
							...
							<p>
								...
								bei der Twanimal GmbH zu wissenschaftlichen oder historischen Forschungszwecken oder zu
							...
							<p>
								...
								Mitarbeiter der Twanimal GmbH oder einen anderen Mitarbeiter wenden. Der betroffenen
						...
						<li>
							...
							<p>
								...
								ausdrücklicher Einwilligung der betroffenen Person, trifft die Twanimal GmbH angemessene
					...
					<h4>
						10. Datenschutzbestimmungen zu Einsatz und Verwendung von Adobe Analytics (Omniture) / Adobe
						Marketing Cloud
					</h4>
					<p>
						...
						sowie eine Web-Analyse ermöglicht. Omniture ist ein Teil der Adobe Marketing Cloud. Die Adobe
						...
						Verantwortlichen ein besserer Überblick über die Onlineaktivitäten der Nutzer dieser
						Internetseite verschafft wird, indem die Daten in einfachen und interaktiven Dashboards
						angezeigt und in Berichte umgewandelt werden. Dies versetzt den für die Verarbeitung
						Verantwortlichen in die Lage, Informationen in Echtzeit zu erhalten und hierdurch auftretende
					...
					<p>
						...
						Geolokalisierung und die Reichweitenmessung unabhängig voneinander anonymisiert werden. Adobe
						wird im Auftrag des für die Verarbeitung Verantwortlichen die über unsere Internetseite
						...
						Nutzeraktivitäten zu erstellen sowie weitere Dienstleistungen für unser Unternehmen zu
						erbringen, die im Zusammenhang mit der Nutzung unserer Internetseite stehen. Die IP-Adresse der
						betroffenen Person wird durch Adobe nicht mit anderen personenbezogenen Daten zusammengeführt.
					</p>
					...
					<p>
						Ferner besteht für die betroffene Person die Möglichkeit, einer Erfassung der durch das
						...
						http://www.adobe.com/de/privacy/opt-out.html drücken, der einen Opt-Out-Cookie setzt. Der mit
						dem Widerspruch gesetzte Opt-Out-Cookie wird auf dem von der betroffenen Person genutzten
					...
					<p>
						...
						für die Verarbeitung Verantwortlichen für die betroffene Person nicht mehr vollumfänglich
						nutzbar sind.
					</p>
					...
					<h4>
						13. Datenschutzbestimmungen zu Einsatz und Verwendung von Funktionen der Verwertungsgesellschaft
						WORT (VG WORT)
					</h4>
					<p>
						...
						Auswertung durchgeführt werden kann. Die integrierten Zählpixel dienen dem Skalierbaren
						Zentralen Messverfahren (SZM) der Verwertungsgesellschaft WORT (VG-Wort).
					</p>

					<p>
						Das Skalierbare Zentrale Messverfahren wird von der INFOnline GmbH, Brühler Str. 9, 53119 Bonn,
						Germany betrieben.
					</p>
					...
					<p>
						...
						Nutzern (darunter ist die betroffene Person) unsere Internetseite geöffnet wurde und welche
						Inhalte abgerufen wurden.
					</p>

					<p>
						Die mittels des Skalierbaren Zentralen Messverfahrens erlangten Daten werden anonym erhoben. Zur
						Erfassung der Zugriffszahlen wird zum Zwecke der Wiedererkennung der Nutzer einer Internetseite
						entweder ein sogenannter Session-Cookie gesetzt, also eine Signatur erstellt, welche sich aus
						verschiedenen automatisch übertragenen Informationen zusammensetzt oder alternative Methoden
						verwendet. Die IP-Adresse des von der betroffenen Person genutzten Internetanschlusses wird nur
						in anonymisierter Form erhoben und verarbeitet. Die betroffene Person wird zu keinem Zeitpunkt
						identifiziert.
					</p>
					...
					<p>
						...
						INFOnline erzeugten, auf eine Nutzung dieser Internetseite bezogenen Daten sowie der
						Verarbeitung dieser Daten durch INFOnline zu widersprechen und eine solche zu verhindern. Hierzu
						muss die betroffene Person den Opt-Out-Button unter dem Link http://optout.ioam.de drücken, der
						einen Opt-Out-Cookie setzt. Der mit dem Widerspruch gesetzte Opt-Out-Cookie wird auf dem von der
						betroffenen Person genutzten informationstechnologischen System abgelegt. Werden die Cookies auf
						dem System der betroffenen Person nach einem Widerspruch gelöscht, muss die betroffene Person
						den Link erneut aufrufen und einen neuen Opt-Out-Cookie setzen.
					</p>
					...
					<p>
						...
						Bildagentur lizensieren unterschiedliche Kunden, insbesondere Internetseitenbetreiber,
						Redaktionen von Print- und TV-Medien und Werbeagenturen, die von ihnen eingesetzten Bilder.
					</p>

					<p>
						Betreibergesellschaft der Getty-Images-Komponenten ist die Getty Images International, 1st
						Floor, The Herbert Building, The Park, Carrickmines, Dublin 18, Irland.
					</p>
					...
					<p>
						...
						oder Bild-Daten, die von einer fremden Internetseite bereitgestellt werden und dann auf der
						eigenen Internetseite erscheinen. Zur Einbettung wird ein sogenannter Einbettungscode verwendet.
						Ein Einbettungscode ist ein HTML-Code, der von einem Internetseitenbetreiber in eine
						Internetseite integriert wird. Wurde von einem Internetseitenbetreiber ein Einbettungscode
						integriert, werden die externen Inhalte der anderen Internetseite standardmäßig unmittelbar
						angezeigt, sobald eine Internetseite besucht wird. Zur Anzeige der fremden Inhalte werden die
						externen Inhalte unmittelbar von der anderen Internetseite geladen. Getty Images stellt unter
						dem Link http://www.gettyimages.de/resources/embed weitere Informationen über das Einbetten von
						Inhalten zur Verfügung.
					</p>

					<p>
						Über die technische Implementierung des Einbettungscodes, der die Bildanzeige der Bilder von
						Getty Images ermöglicht, wird die IP-Adresse des Internetanschlusses, über welchen die
						betroffene Person auf unsere Internetseite zugreift, an Getty Images übertragen. Ferner erfasst
						Getty Images unsere Internetseite, den genutzten Browsertyp, die Browsersprache, den Zeitpunkt
						und die Länge des Zugriffs. Darüber hinaus kann Getty Images Navigationsinformationen, das sind
						Informationen darüber, welche unserer Unterseiten von der betroffenen Person besucht und welche
						Links angeklickt wurden, sowie andere Interaktionen, die die betroffene Person beim Besuch
						unserer Internetseite ausgeführt hat, erfassen. Diese Daten können von Getty Images gespeichert
						und ausgewertet werden.
					</p>

					<p>
						Weitere Informationen und die geltenden Datenschutzbestimmungen von Getty Images können unter
						https://www.gettyimages.de/company/privacy-policy abgerufen werden.
					</p>
					...
					<p>
						...
						Zusatz "_gat._anonymizeIp". Mittels dieses Zusatzes wird die IP-Adresse des Internetanschlusses
						der betroffenen Person von Google gekürzt und anonymisiert, wenn der Zugriff auf unsere
					...
					<p>
						Betreibergesellschaft der Dienste von Google Remarketing ist die Google Ireland Limited, Gordon
						House, Barrow Street, Dublin, D04 E5W5, Ireland.
					</p>
					...
					<h4>18. Datenschutzbestimmungen zu Einsatz und Verwendung von Jetpack für WordPress</h4>
					<p>
						Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Jetpack integriert.
						Jetpack ist ein WordPress-Plug-In, welches dem Betreiber einer Internetseite, die auf WordPress
						aufbaut, zusätzliche Funktionen bietet. Jetpack gestattet dem Internetseitenbetreiber unter
						anderem eine Übersicht über die Besucher der Seite. Durch die Anzeige von verwandten Beiträgen
						und Publikationen oder die Möglichkeit, Inhalte auf der Seite zu teilen, ist ferner die
						Steigerung der Besucherzahlen möglich. Außerdem sind Sicherheitsfunktionen in Jetpack
						integriert, sodass eine Jetpack nutzende Internetseite besser gegen Brute-Force-Attacken
						geschützt ist. Jetpack optimiert und beschleunigt ferner das Laden der auf der Internetseite
						integrierten Bilder.
					</p>

					<p>
						Betreibergesellschaft des Jetpack-Plug-Ins für WordPress ist die Aut O’Mattic A8C Ireland Ltd.,
						Business Centre, No.1 Lower Mayor Street, International Financial Services Centre, Dublin 1,
						Ireland.
					</p>
					...
					<p>
						...
						welcher eine Jetpack-Komponente integriert wurde, wird der Internetbrowser auf dem
						informationstechnologischen System der betroffenen Person automatisch durch die jeweilige
						Jetpack-Komponente veranlasst, Daten zur Analysezwecken an Automattic zu übermitteln. Im Rahmen
						dieses technischen Verfahrens erhält Automattic Kenntnis über Daten, die in der Folge zur
						Erstellung einer Übersicht der Internetseiten-Besuche verwendet werden. Die so gewonnenen Daten
						dienen der Analyse des Verhaltens der betroffenen Person, welche auf die Internetseite des für
						die Verarbeitung Verantwortlichen zugegriffen hat und werden mit dem Ziel, die Internetseite zu
						optimieren, ausgewertet. Die über die Jetpack-Komponente erhobenen Daten werden nicht ohne eine
						vorherige Einholung einer gesonderten ausdrücklichen Einwilligung der betroffenen Person dazu
						genutzt, die betroffene Person zu identifizieren. Die Daten gelangen ferner Quantcast zur
					...
					<p>
						...
						dem informationstechnologischen System der betroffenen Person setzt. Zudem können von Automattic
					...
					<p>
						Ferner besteht für die betroffene Person die Möglichkeit, einer Erfassung der durch das
						Jetpack-Cookie erzeugten, auf eine Nutzung dieser Internetseite bezogenen Daten sowie der
						Verarbeitung dieser Daten durch Automattic/Quantcast zu widersprechen und eine solche zu
						verhindern. Hierzu muss die betroffene Person den Opt-Out-Button unter dem Link
						https://www.quantcast.com/opt-out/ drücken, der einen Opt-Out-Cookie setzt. Der mit dem
					...
					<p>
						Betreibergesellschaft von Twitter International Company, One Cumberland Place, Fenian Street
					...
					<h4>20. Datenschutzbestimmungen zu Einsatz und Verwendung von DoubleClick</h4>
					<p>
						...
						vorwiegend spezielle Online-Marketing-Lösungen an Werbeagenturen und Verlage vermarktet werden.
					</p>

					<p>
						Betreibergesellschaft von Google Ireland Limited, Gordon House, Barrow Street, Dublin, D04 E5W5,
						Ireland.
					</p>

					<p>
						DoubleClick by Google überträgt sowohl mit jeder Impression als auch mit Klicks oder anderen
						Aktivitäten Daten auf den DoubleClick-Server. Jede dieser Datenübertragungen löst eine
						Cookie-Anfrage an den Browser der betroffenen Person aus. Akzeptiert der Browser diese Anfrage,
						setzt DoubleClick ein Cookie auf dem informationstechnologischen System der betroffenen Person.
						Was Cookies sind, wurde oben bereits erläutert. Zweck des Cookies ist die Optimierung und
						Einblendung von Werbung. Das Cookie wird unter anderem dazu verwendet, nutzerrelevante Werbung
						zu schalten und anzuzeigen sowie um Berichte zu Werbekampagnen zu erstellen oder diese zu
						verbessern. Ferner dient das Cookie dazu, Mehrfacheinblendungen derselben Werbung zu vermeiden.
					</p>

					<p>
						DoubleClick verwendet eine Cookie-ID, die zur Abwicklung des technischen Verfahrens erforderlich
						ist. Die Cookie-ID wird beispielsweise benötigt, um eine Werbeanzeige in einem Browser
						anzuzeigen. DoubleClick kann über die Cookie-ID zudem erfassen, welche Werbeanzeigen bereits in
						einem Browser eingeblendet wurden, um Doppelschaltungen zu vermeiden. Ferner ist es DoubleClick
						durch die Cookie-ID möglich, Conversions zu erfassen. Conversions werden beispielsweise dann
						erfasst, wenn einem Nutzer zuvor eine DoubleClick-Werbeanzeige eingeblendet wurde und dieser in
						der Folge mit dem gleichen Internetbrowser einen Kauf auf der Internetseite des Werbetreibenden
						vollzieht.
					</p>

					<p>
						Ein Cookie von DoubleClick enthält keine personenbezogenen Daten. Ein DoubleClick-Cookie kann
						aber zusätzliche Kampagnen-Kennungen enthalten. Eine Kampagnen-Kennung dient einer
						Identifizierung der Kampagnen, mit denen der Nutzer bereits in Kontakt war.
					</p>

					<p>
						Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die durch den für die
						Verarbeitung Verantwortlichen betrieben wird und auf welcher eine DoubleClick-Komponente
						integriert wurde, wird der Internetbrowser auf dem informationstechnologischen System der
						betroffenen Person automatisch durch die jeweilige DoubleClick-Komponente veranlasst, Daten zum
						Zwecke der Online-Werbung und der Abrechnung von Provisionen an Google zu übermitteln. Im Rahmen
					...
					<p>
						...
						verhindern und damit der Setzung von Cookies dauerhaft widersprechen. Eine solche Einstellung
						des genutzten Internetbrowsers würde auch verhindern, dass Google ein Cookie auf dem
						informationstechnologischen System der betroffenen Person setzt. Zudem können von Google bereits
						gesetzte Cookies jederzeit über einen Internetbrowser oder andere Softwareprogramme gelöscht
						werden.
					</p>

					<p>
						Weitere Informationen und die geltenden Datenschutzbestimmungen von DoubleClick by Google können
						unter https://www.google.com/intl/de/policies/ abgerufen werden.
					</p>

					<h4>21. Datenschutzbestimmungen zu Einsatz und Verwendung von Belboon</h4>
					<p>
						...
						Affiliate-Marketing ist eine Internetgestützte Vertriebsform, die es kommerziellen Betreibern
						von Internetseiten, den sogenannten Merchants oder Advertisern, ermöglicht, Werbung, die meist
						über Klick- oder Sale-Provisionen vergütet wird, auf Internetseiten Dritter, also bei
						...
						Internetseiten eingebunden oder über sonstige Kanäle, wie etwa das Keyword-Advertising oder
					...
					<p>
						...
						einer Internetseite und des angeklickten Werbemittels. Zweck der Speicherung dieser Daten ist
						die Abwicklung von Provisionszahlungen zwischen einem Merchant und dem Affiliate, welche über
						das Affiliate-Netzwerk, also Belboon, abgewickelt werden.
					</p>
					...
					<h4>
						22. Datenschutzbestimmungen zu Einsatz und Verwendung von Oracle Eloqua / Oracle Marketing Cloud
					</h4>
					<p>
						...
						anzusprechen. Zweck von Eloqua ist es, die Konversionrate von Interessenten in Kunden zu erhöhen
						und damit den Umsatz eines Internetseitenbetreibers zu erhöhen.
					</p>

					<p>
						Betreibergesellschaft von Eloqua ist die Oracle Corporation, 10 Van de Graaff Drive, Burlington,
						MA 01803, USA.
					</p>
					...
					<p>
						...
						informationstechnologischen System der betroffenen Person setzt. Zudem können von Oracle bereits
						gesetzte Cookies jederzeit über den Internetbrowser oder andere Softwareprogramme gelöscht
						werden.
					</p>

					<p>
						Ferner besteht für die betroffene Person die Möglichkeit, der Erfassung der durch das
						Eloqua-Cookie erzeugten, auf eine Nutzung dieser Internetseite bezogenen Daten sowie der
						Verarbeitung dieser Daten durch Oracle zu widersprechen und eine solche zu verhindern. Hierzu
						muss die betroffene Person den Click-Here-Button unter
						https://www.oracle.com/marketingcloud/opt-status.html drücken, der einen Opt-Out-Cookie setzt.
					...
					<h4>23. Zahlungsart: Datenschutzbestimmungen zu Klarna als Zahlungsart</h4>
					<p>
					...
					<p>
						Betreibergesellschaft von Klarna ist die Klarna Bank AB, Sveavägen 46, 111 34 Stockholm,
						Schweden.
					</p>

					<p>
						Wählt die betroffene Person während des Bestellvorgangs in unserem Online-Shop als
						Zahlungsmöglichkeit entweder den „Kauf auf Rechnung“ oder „Ratenkauf“ aus, werden automatisiert
						Daten der betroffenen Person an Klarna übermittelt. Mit der Auswahl einer dieser
					...
					<p>
						...
						notwendig sind. Zur Abwicklung des Kaufvertrages notwendig sind auch solche personenbezogenen
						Daten, die im Zusammenhang mit der jeweiligen Bestellung stehen. Insbesondere kann es zum
						wechselseitigen Austausch von Zahlungsinformationen, wie Bankverbindung, Kartennummer,
						Gültigkeitsdatum und CVC-Code, Artikelanzahl, Artikelnummer, Daten zu Waren und
						Dienstleistungen, Preise und steuerliche Abgaben, Angaben zum früheren Kaufverhalten oder
						sonstige Angaben zur finanziellen Situation der betroffenen Person, kommen. 
					</p>
					...
					<p>
						...
						ausgetauschten personenbezogenen Daten werden von Klarna an Wirtschaftsauskunfteien übermittelt.
					...
					<p>
						...
						betroffenen Person sowie Wahrscheinlichkeitswerte für deren Verhalten in der Zukunft
						(sogenanntes Scoring). Die Berechnung des Scorings wird auf der Basis wissenschaftlich
					...
					<p>
						...
						https://cdn.klarna.com/1.0/shared/content/policy/data/de_de/data_protection.pdf abgerufen
						werden.
					</p>

					<h4>24. Zahlungsart: Datenschutzbestimmungen zu PayPal als Zahlungsart</h4>
					<p>
						Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten von PayPal
						integriert. PayPal ist ein Online-Zahlungsdienstleister. Zahlungen werden über sogenannte
						PayPal-Konten abgewickelt, die virtuelle Privat- oder Geschäftskonten darstellen. Zudem besteht
						bei PayPal die Möglichkeit, virtuelle Zahlungen über Kreditkarten abzuwickeln, wenn ein Nutzer
						kein PayPal-Konto unterhält. Ein PayPal-Konto wird über eine E-Mail-Adresse geführt, weshalb es
					...
					<p>
						...
						Daten, die zur Zahlungsabwicklung notwendig sind. Zur Abwicklung des Kaufvertrages notwendig
						sind auch solche personenbezogenen Daten, die im Zusammenhang mit der jeweiligen Bestellung
						stehen.
					</p>
					...
					<h4>25. Zahlungsart: Datenschutzbestimmungen zu Sofortüberweisung als Zahlungsart</h4>
					<p>
						Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten von
						...
						technisches Verfahren ab, durch welches der Online-Händler unverzüglich eine Zahlungsbestätigung
						erhält. So wird ein Händler in die Lage versetzt, Waren, Dienstleistungen oder Downloads sofort
						nach der Bestellung an den Kunden auszuliefern.
					</p>

					<p>
						Betreibergesellschaft von Sofortüberweisung ist die Klarna Bank AB, Sveavägen 46, 111 34
						Stockholm, Schweden.
					</p>
					...
					<p>
						Bei der Kaufabwicklung über Sofortüberweisung übermittelt der Käufer die PIN und die TAN an die
						Sofort GmbH. Sofortüberweisung führt sodann nach technischer Überprüfung des Kontostandes und
						Abruf weiterer Daten zur Prüfung der Kontodeckung eine Überweisung an den Online-Händler aus.
					...
					<p>
						...
						Nachname, Adresse, Email-Adresse, IP-Adresse, Telefonnummer, Mobiltelefonnummer oder andere
						Daten, die zur Zahlungsabwicklung notwendig sind. Die Übermittlung der Daten bezweckt die
						Zahlungsabwicklung und die Betrugsprävention. Der für die Verarbeitung Verantwortliche wird
						Sofortüberweisung andere personenbezogene Daten auch dann übermitteln, wenn ein berechtigtes
						Interesse für die Übermittlung gegeben ist. Die zwischen Sofortüberweisung und dem für die
						Verarbeitung Verantwortlichen ausgetauschten personenbezogenen Daten werden von
						Sofortüberweisung unter Umständen an Wirtschaftsauskunfteien übermittelt. Diese Übermittlung
						bezweckt die Identitäts- und Bonitätsprüfung.
					</p>

					<p>
						Sofortüberweisung gibt die personenbezogenen Daten gegebenenfalls an verbundene Unternehmen und
						Leistungserbringer oder Subunternehmer weiter, soweit dies zur Erfüllung der vertraglichen
						Verpflichtungen erforderlich ist oder die Daten im Auftrag verarbeitet werden sollen.
					</p>
					...
					<h4>
						27. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder einem Dritten
						verfolgt werden
					</h4>
					<p>
					...
					<h4>28. Dauer, für die die personenbezogenen Daten gespeichert werden</h4>
					<p>
